...
class SingleMovieDetails extends Component {
  ...
  getMovieDetails = async () => {
    ...
    const {params} = match
    const {id} = params
    const getMovieApi = `https://api.themoviedb.org/3/movie/${id}?api_key=3bc3168ec6c38084807eb13705f78318&language=en-US`
    const getCastApi = `https://api.themoviedb.org/3/movie/${id}/credits?api_key=3bc3168ec6c38084807eb13705f78318&language=en-US`
